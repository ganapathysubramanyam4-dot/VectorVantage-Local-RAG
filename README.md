...
2. Pull the Mistral Model: Open your command prompt/terminal and run: ollama pull mistral

## 💻 How to Run

1. Install Dependencies: Make sure you have your environment ready, then install all required libraries: pip install -r requirements.txt

2. Start the Ollama Server: Ensure your local neural instance is live: ollama run mistral

3. Launch the Streamlit Application: Run the web interface: streamlit run app_web.py

## 📂 Project Structure
* app_web.py - Core Streamlit application code containing the UI layout and RAG pipelines.
* requirements.txt - Python dependencies mappings.
* faiss_index/ - Automatically generated local directory containing vectorized document fragments.
